...
3. It is given that 42% of the sample
...
1. The number of days in which 5
...
2. The number of waiting costumers that
...
3. The value “0”, which occurred only
...
1. The relative frequency of direct hits of
...
2. The relative frequency of direct hits of
...
involved in this study is 45. The object “`freq`" contain the table of
...
“7" in the output of the expression “`cumsum(freq)`". This number is 45.

2. The number of cows that gave birth to a
...
3. The relative frequency of cows that gave
...
the summary of “`x1`" with Histogram 1.
